 ...
 * @Author: lxt 
 * @Date: 2019-02-25 18:10
 * @Version 1.0
 **/
public class ZxingUtils {
    private final static Logger logger = LoggerFactory.getLogger(ZxingUtils.class);
    ...
    public static File getQRCodeImge(String contents, String imgPath) {
        return getQRCodeImge(contents, DEFAULT_WIDTH, DEFAULT_WIDTH, imgPath);
    }
    ...
    public static File getQRCodeImge(String contents, int width, int height, String imgPath) {
        try {
            ...
            logger.error("create QR code error!", var7);
            return null;
        }
    }
}
