 ...
 * =============================================================================
 */
package com.lxt.lxtpay.module.unionpay.sdk;
...
public class SDKConfig {
	public static final String FILE_NAME = "union-acp-sdk.properties";
	/** 前台请求URL. */
	 ...
	 * 商户号
	 */
	public static final String SDK_MER_ID = "acpsdk.merId";
	/** 后台通知地址  */
	...
	public void loadProperties(Properties pro) {
		...
		value = pro.getProperty(SDK_MER_ID);
		if (!SDKUtil.isEmpty(value)) {
	...
	public SDKConfig setMerId(String merId) {
		this.merId = merId;
		return this;
	}
